...
void login() {
    printf("Login with GDE \n");
    printf("\t+91_");
    scanf("%s", f.ph);  // Changed to string input
    printf("\tOther login options:\n");
    printf("\t\tLog in with Google\n");
    printf("\t\tLog in with Facebook\n\n");
    ...
    if (islower(f.mail[0])) {
        ...
        printf("Please enter a valid email ID (start with a lowercase letter).\n");
        return;
    }
